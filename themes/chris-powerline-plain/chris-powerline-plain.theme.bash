...
USER_INFO_THEME_PROMPT_COLOR=37
...
SCM_THEME_PROMPT_CLEAN_COLOR=33
SCM_THEME_PROMPT_DIRTY_COLOR=166
SCM_THEME_PROMPT_STAGED_COLOR=136
SCM_THEME_PROMPT_UNSTAGED_COLOR=64
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="user_info scm cwd"}
